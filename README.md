<h1 align="center">JS - Projeto Slider </h1>

# Índice
- [Índice](#índice)
- [🛠 Sobre o Projeto JS - Slider](#-sobre-o-projeto-js---slider)
...
```js
    ...
    $ git clone https://github.com/TayseRosa/js-slider.git
